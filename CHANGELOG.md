...
- feat: Move ACL storage to private data [\#236](https://github.com/rtang03/fabric-es/pull/236) ([pangduckwai](https://github.com/pangduckwai))
- fix: Refactor dev-net individual env specific config [\#232](https://github.com/rtang03/fabric-es/pull/232) ([pangduckwai](https://github.com/pangduckwai))
...
- debug followup Issue226 [\#229](https://github.com/rtang03/fabric-es/issues/229)
- unexpected error found [\#226](https://github.com/rtang03/fabric-es/issues/226)
- add Redis ping in pipelineExec as a pre-req to call redis [\#230](https://github.com/rtang03/fabric-es/pull/230) ([rtang03](https://github.com/rtang03))

**Closed issues:**

- when submitting tx, DefaultEventHandlerOptions timeout [\#228](https://github.com/rtang03/fabric-es/issues/228)
...
- getById should use commandGetById [\#223](https://github.com/rtang03/fabric-es/issues/223)

**Closed issues:**

- feat : add https support in createGateway  [\#221](https://github.com/rtang03/fabric-es/issues/221)

**Merged pull requests:**

- chore: add debug in createQueryDatabase.ts and reducer.ts [\#227](https://github.com/rtang03/fabric-es/pull/227) ([rtang03](https://github.com/rtang03))
