...
fabric-ca-client register -d --id.name peer1.org1.example.com --id.secret C2npBNcf --id.type peer -u https://0.0.0.0:5054
...
fabric-ca-client enroll -d -u https://peer1.org1.example.com:C2npBNcf@0.0.0.0:5054
