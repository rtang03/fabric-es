...
fabric-ca-client register -d --id.name peer0.pbctfp.net --id.secret 4PBPEkwt --id.type peer -u https://0.0.0.0:6055
fabric-ca-client register -d --id.name peer1.pbctfp.net --id.secret Q528SdnZ --id.type peer -u https://0.0.0.0:6055
fabric-ca-client register -d --id.name admin-pbctfp.net --id.secret mEN6bpQW --id.type admin --id.attrs "hf.Registrar.Attributes=*,hf.Revoker=true,hf.GenCRL=true,admin=true:ecert,abac.init=true:ecert" -u https://0.0.0.0:6055
