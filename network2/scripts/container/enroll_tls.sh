...
fabric-ca-client enroll -d -u https://peer0.org1.example.com:peer0PW@0.0.0.0:5052 --enrollment.profile tls --csr.hosts peer0.org1.example.com
...
fabric-ca-client enroll -d -u https://peer1.org1.example.com:peer1PW@0.0.0.0:5052 --enrollment.profile tls --csr.hosts peer1.org1.example.com
...
fabric-ca-client enroll -d -u https://peer0.org2.example.com:peer0PW@0.0.0.0:5052 --enrollment.profile tls --csr.hosts peer0.org2.example.com
...
fabric-ca-client enroll -d -u https://peer1.org2.example.com:peer1PW@0.0.0.0:5052 --enrollment.profile tls --csr.hosts peer1.org2.example.com
...
fabric-ca-client enroll -d -u https://orderer1.example.com:ordererPW@0.0.0.0:5052 --enrollment.profile tls --csr.hosts orderer1.example.com
...
fabric-ca-client enroll -d -u https://orderer2.example.com:ordererPW@0.0.0.0:5052 --enrollment.profile tls --csr.hosts orderer2.example.com
...
fabric-ca-client enroll -d -u https://orderer3.example.com:ordererPW@0.0.0.0:5052 --enrollment.profile tls --csr.hosts orderer3.example.com
...
fabric-ca-client enroll -d -u https://orderer4.example.com:ordererPW@0.0.0.0:5052 --enrollment.profile tls --csr.hosts orderer4.example.com
...
fabric-ca-client enroll -d -u https://orderer5.example.com:ordererPW@0.0.0.0:5052 --enrollment.profile tls --csr.hosts orderer5.example.com
