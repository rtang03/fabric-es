...
cp /var/artifacts/crypto-config/HsbcMSP/ca/admin/msp/cacerts/0-0-0-0-5054.pem /var/artifacts/crypto-config/HsbcMSP/peer0.hsbc.com.hk/assets/ca/hsbc.com.hk-ca-cert.pem

# Enroll peer0
export FABRIC_CA_CLIENT_TLS_CERTFILES=/var/artifacts/crypto-config/HsbcMSP/peer0.hsbc.com.hk/assets/ca/hsbc.com.hk-ca-cert.pem
...
cp /var/artifacts/crypto-config/HsbcMSP/ca/admin/msp/cacerts/0-0-0-0-5054.pem /var/artifacts/crypto-config/HsbcMSP/peer1.hsbc.com.hk/assets/ca/hsbc.com.hk-ca-cert.pem

# Enroll peer1
export FABRIC_CA_CLIENT_TLS_CERTFILES=/var/artifacts/crypto-config/HsbcMSP/peer1.hsbc.com.hk/assets/ca/hsbc.com.hk-ca-cert.pem
...
cp /var/artifacts/crypto-config/HsbcMSP/admin/msp/signcerts/cert.pem /var/artifacts/crypto-config/HsbcMSP/peer0.hsbc.com.hk/msp/admincerts/hsbc.com.hk-admin-cert.pem
# Copy admin cert to peer1
mkdir -p /var/artifacts/crypto-config/HsbcMSP/peer1.hsbc.com.hk/msp/admincerts
cp /var/artifacts/crypto-config/HsbcMSP/admin/msp/signcerts/cert.pem /var/artifacts/crypto-config/HsbcMSP/peer1.hsbc.com.hk/msp/admincerts/hsbc.com.hk-admin-cert.pem
