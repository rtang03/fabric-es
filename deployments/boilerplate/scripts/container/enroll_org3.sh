...
fabric-ca-client register -d --id.name peer0.hsbc.com.hk --id.secret password --id.type peer -u https://0.0.0.0:5054
fabric-ca-client register -d --id.name peer1.hsbc.com.hk --id.secret password --id.type peer -u https://0.0.0.0:5054
fabric-ca-client register -d --id.name admin-hsbc.com.hk --id.secret password --id.type admin --id.attrs "hf.Registrar.Attributes=*,hf.Revoker=true,hf.GenCRL=true,admin=true:ecert,abac.init=true:ecert" -u https://0.0.0.0:5054
...
fabric-ca-client enroll -d -u https://peer0.hsbc.com.hk:password@0.0.0.0:5054
...
fabric-ca-client enroll -d -u https://peer1.hsbc.com.hk:password@0.0.0.0:5054

# Enroll hsbc's Admin
export FABRIC_CA_CLIENT_HOME=/var/artifacts/crypto-config/HsbcMSP/admin
export FABRIC_CA_CLIENT_TLS_CERTFILES=/var/artifacts/crypto-config/HsbcMSP/peer0.hsbc.com.hk/assets/ca/hsbc-ca-cert.pem
export FABRIC_CA_CLIENT_MSPDIR=msp
fabric-ca-client enroll -d -u https://admin-hsbc.com.hk:password@0.0.0.0:5054
