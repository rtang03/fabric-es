...
cp /var/artifacts/crypto-config/EtcMSP/ca/admin/msp/cacerts/0-0-0-0-6054.pem /var/artifacts/crypto-config/EtcMSP/peer0.etradeconnect.net/assets/ca/etradeconnect.net-ca-cert.pem

# Enroll peer0
export FABRIC_CA_CLIENT_TLS_CERTFILES=/var/artifacts/crypto-config/EtcMSP/peer0.etradeconnect.net/assets/ca/etradeconnect.net-ca-cert.pem
...
cp /var/artifacts/crypto-config/EtcMSP/ca/admin/msp/cacerts/0-0-0-0-6054.pem /var/artifacts/crypto-config/EtcMSP/peer1.etradeconnect.net/assets/ca/etradeconnect.net-ca-cert.pem

# Enroll peer1
export FABRIC_CA_CLIENT_TLS_CERTFILES=/var/artifacts/crypto-config/EtcMSP/peer1.etradeconnect.net/assets/ca/etradeconnect.net-ca-cert.pem
...
cp /var/artifacts/crypto-config/EtcMSP/admin/msp/signcerts/cert.pem /var/artifacts/crypto-config/EtcMSP/peer0.etradeconnect.net/msp/admincerts/etradeconnect.net-admin-cert.pem
# Copy admin cert to peer1
mkdir -p /var/artifacts/crypto-config/EtcMSP/peer1.etradeconnect.net/msp/admincerts
cp /var/artifacts/crypto-config/EtcMSP/admin/msp/signcerts/cert.pem /var/artifacts/crypto-config/EtcMSP/peer1.etradeconnect.net/msp/admincerts/etradeconnect.net-admin-cert.pem
