members="'EtcMSP.member' ,'PbctfpMSP.member',"
...
peer chaincode instantiate -o orderer0-hktfp:7050 -C loanapp -n eventstore -v 1.0 -l node \
...
peer chaincode instantiate -o orderer0-hktfp:7050 -C loanapp -n privatedata -v 1.0 -l node \
