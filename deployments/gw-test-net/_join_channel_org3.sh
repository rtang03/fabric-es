...
cp /var/artifacts/crypto-config/HsbcMSP/peer0.hsbc.com.hk/msp/admincerts/hsbc-admin-cert.pem /var/artifacts/crypto-config/HsbcMSP/admin/msp/admincerts

export CORE_PEER_MSPCONFIGPATH=/var/artifacts/crypto-config/HsbcMSP/admin/msp

# peer0 joining the channel
export CORE_PEER_ADDRESS=peer0-hsbc:7451
...
export CORE_PEER_ADDRESS=peer1-hsbc:7551
peer channel join -b /var/artifacts/crypto-config/HsbcMSP/peer0.hsbc.com.hk/assets/loanapp.block
peer channel getinfo -c loanapp
