...
kubectl -n n0 delete secret orderer0.org0.com-signcert
...
kubectl -n n0 delete secret orderer1.org0.com-signcert
...
kubectl -n n0 delete secret orderer2.org0.com-signcert
...
kubectl -n n0 delete secret orderer3.org0.com-signcert
...
kubectl -n n0 delete secret orderer4.org0.com-signcert
