...
preventEmptyValue "./Org0MSP/orderer0.org0.com/msp/cacerts/0-0-0-0-7054.pem" $CONTENT
...
preventEmptyValue "./Org0MSP/orderer1.org0.com/msp/cacerts/0-0-0-0-7054.pem" $CONTENT
...
preventEmptyValue "./Org0MSP/orderer2.org0.com/msp/cacerts/0-0-0-0-7054.pem" $CONTENT
...
preventEmptyValue "./Org0MSP/orderer3.org0.com/msp/cacerts/0-0-0-0-7054.pem" $CONTENT
...
preventEmptyValue "./Org0MSP/orderer4.org0.com/msp/cacerts/0-0-0-0-7054.pem" $CONTENT
...
preventEmptyValue "./Org0MSP/orderer0.org0.com/tls-msp/tlscacerts/tls-0-0-0-0-7054.pem" $CONTENT
...
preventEmptyValue "./Org0MSP/orderer1.org0.com/tls-msp/tlscacerts/tls-0-0-0-0-7054.pem" $CONTENT
...
preventEmptyValue "./Org0MSP/orderer2.org0.com/tls-msp/tlscacerts/tls-0-0-0-0-7054.pem" $CONTENT
...
preventEmptyValue "./Org0MSP/orderer3.org0.com/tls-msp/tlscacerts/tls-0-0-0-0-7054.pem" $CONTENT
...
preventEmptyValue "./Org0MSP/orderer4.org0.com/tls-msp/tlscacerts/tls-0-0-0-0-7054.pem" $CONTENT
...
preventEmptyValue "./Org0MSP/orderer0.org0.com/msp/admincerts/*.pem" $CONTENT
...
preventEmptyValue "./Org0MSP/orderer1.org0.com/msp/admincerts/*.pem" $CONTENT
...
preventEmptyValue "./Org0MSP/orderer2.org0.com/msp/admincerts/*.pem" $CONTENT
...
preventEmptyValue "./Org0MSP/orderer3.org0.com/msp/admincerts/*.pem" $CONTENT
...
preventEmptyValue "./Org0MSP/orderer4.org0.com/msp/admincerts/*.pem" $CONTENT
