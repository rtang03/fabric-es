...
import { CREATE_LOAN_DETAILS, UPDATE_LOAN_DETAILS } from '@fabric-es/model-loan';
...
beforeAll(async () => {
  service = new ApolloServer({
    schema: buildFederatedSchema([
      { typeDefs: loanDetailsTypeDefs, resolvers: loanDetailsResolvers },
    ]),
    dataSources: () => ({
    ...
    createTestClient(service)
      .mutate({
        ...
        variables: {
          ...
          loanId: 'L0003',
          requester: {
            registration: 'REG-0003',
            name: 'Loan Requester 3',
          },
          contact: {
            name: 'Contact 3',
            phone: '555-0003',
    ...
    createTestClient(service)
      .mutate({
        ...
        variables: {
          ...
          loanId: 'L0004',
          requester: {
            registration: 'REG-0004',
            name: 'Loan Requester 4',
          },
          contact: {
            name: 'Contact 4',
            phone: '555-0004',
    ...
    createTestClient(service)
      .mutate({
        ...
        variables: {
          ...
          loanId: 'L0005',
          requester: {
            registration: 'REG-0005',
            name: 'Loan Requester 5',
          },
          contact: {
            name: 'Contact 5',
            phone: '555-0005',
    ...
    createTestClient(service)
      .mutate({
        ...
        variables: {
          ...
          loanId: 'L0006',
          requester: {
            registration: 'REG-0006',
            name: 'Loan Requester 6',
          },
          contact: {
            name: 'Contact 6',
            phone: '555-0006',
    ...
    createTestClient(service)
      .mutate({
        ...
        variables: {
          ...
          loanId: 'L0007',
          requester: {
            registration: 'REG-0007',
            name: 'Loan Requester 7',
            type: 'Da Yee Lung',
          },
          contact: {
            name: 'Contact 7',
    ...
    createTestClient(service)
      .mutate({
        ...
        variables: {
          ...
          loanId: 'L0008',
          requester: {
            registration: 'REG-0008',
            name: 'Loan Requester 8',
            type: 'Da Yee Lung',
          },
          contact: {
            salutation: 'Dr',
          ...
          loanType: 'No Shipment',
          startDate: '1542385275438',
          tenor: 78,
          currency: 'HKD',
          requestedAmt: 50000,
          approvedAmt: 49999,
    ...
    createTestClient(service)
      .mutate({
        ...
        variables: {
          ...
          loanId: 'L0000',
          requester: {
            registration: 'REG-0000VERWRITTEN',
            name: 'Loan Requester 0VERWRITTEN',
          },
          contact: {
            name: 'Contact 0VERWRITTEN',
            phone: '555-0000',
            email: 'c0000@fake.it',
            company: 'Hark Dim',
          },
    ...
    createTestClient(service)
      .mutate({
        ...
        variables: {
          ...
          loanId: 'L9999',
          requester: {
            registration: 'REG-9999',
            name: 'Loan Requester 9',
          },
          contact: {
            name: 'Contact 9',
            phone: '555-9999',
    ...
    createTestClient(service)
      .mutate({
        ...
        variables: {
          ...
          loanId: 'L0002',
          currency: 'USD',
          comment: 'Hello 0002 EDITED',
        },
      })
      .then(({ data }) =>
        expect(data.updateLoanDetails.map((d) => (d && d.id ? d.id : ''))).toContain('L0002')
      )
      .catch((_) => expect(false).toBeTruthy()));
    ...
    createTestClient(service)
      .mutate({
        ...
        variables: {
          userId,
          loanId: 'L0006',
          contact: { name: 'Contact 6 EDITED' },
          comment: 'Hello 0006 EDITED',
        },
      })
      .then(({ data }) =>
        expect(data.updateLoanDetails.map((d) => (d && d.id ? d.id : ''))).toContain('L0006')
      )
      .catch((_) => expect(false).toBeTruthy()));
    ...
    createTestClient(service)
      .mutate({
        ...
        variables: {
          userId,
          loanId: 'L0007',
          contact: { name: 'Contact 7 EDITED', phone: '555-9997' },
          comment: 'Hello 0007 EDITED',
        },
      })
      .then(({ data }) =>
        expect(data.updateLoanDetails.map((d) => (d && d.id ? d.id : ''))).toContain('L0007')
      )
      .catch((_) => expect(false).toBeTruthy()));
    ...
    createTestClient(service)
      .mutate({
        ...
        variables: {
          userId,
          loanId: 'L0008',
          contact: { name: 'Contact 8 EDITED', phone: '555-9998' },
          comment: 'Hello 0008 EDITED',
          loanType: 'Pre-Shipment',
          requestedAmt: 50001,
          approvedAmt: 49998,
        },
      })
      .then(({ data }) =>
        expect(data.updateLoanDetails.map((d) => (d && d.id ? d.id : ''))).toContain('L0008')
      )
      .catch((_) => expect(false).toBeTruthy()));
