...
export type Query = {
  ...
  getCaIdentities?: Maybe<CaIdentity[]>;
...
> = {
  ...
  transaction?: Resolver<ResolversTypes['TransactionData'][], ParentType, ContextType>;
};

export type CaIdentityResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['CaIdentity'] = ResolversParentTypes['CaIdentity']
> = {
  ...
  attrs?: Resolver<ResolversTypes['X509Attribute'][], ParentType, ContextType>;
};

export type ChaincodeResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['Chaincode'] = ResolversParentTypes['Chaincode']
> = {
...
export type ChannelInfoResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['ChannelInfo'] = ResolversParentTypes['ChannelInfo']
> = {
  channel_id?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
};

export type ChannelPeerResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['ChannelPeer'] = ResolversParentTypes['ChannelPeer']
> = {
...
export type CollectionConfigResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['CollectionConfig'] = ResolversParentTypes['CollectionConfig']
> = {
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  typ?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
> = {
  registerAndEnrollUser?: Resolver<
    ResolversTypes['Boolean'],
    ParentType,
    ContextType,
    RequireFields<MutationRegisterAndEnrollUserArgs, 'enrollmentId' | 'enrollmentSecret'>
  >;
};

export type PeerInfoResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['PeerInfo'] = ResolversParentTypes['PeerInfo']
> = {
  mspid?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
> = {
  ...
  getBlockByNumber?: Resolver<
    Maybe<ResolversTypes['Block']>,
    ParentType,
    ContextType,
    RequireFields<QueryGetBlockByNumberArgs, 'blockNumber'>
  >;
  getMspid?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  getInstalledChaincodes?: Resolver<ResolversTypes['Chaincode'][], ParentType, ContextType>;
  getInstantiatedChaincodes?: Resolver<ResolversTypes['Chaincode'][], ParentType, ContextType>;
  getInstalledCCVersion?: Resolver<
    ResolversTypes['String'],
    ParentType,
    ContextType,
    RequireFields<QueryGetInstalledCcVersionArgs, 'chaincode_id'>
  >;
  getCaIdentities?: Resolver<Maybe<ResolversTypes['CaIdentity'][]>, ParentType, ContextType>;
  getCaIdentityByEnrollmentId?: Resolver<
    Maybe<ResolversTypes['CaIdentity']>,
    ParentType,
    ContextType,
    RequireFields<QueryGetCaIdentityByEnrollmentIdArgs, 'enrollmentId'>
  >;
  listWallet?: Resolver<ResolversTypes['WalletEntry'][], ParentType, ContextType>;
  isWalletEntryExist?: Resolver<
    ResolversTypes['Boolean'],
    ParentType,
    ContextType,
    RequireFields<QueryIsWalletEntryExistArgs, 'label'>
  >;
  getCollectionConfigs?: Resolver<ResolversTypes['CollectionConfig'][], ParentType, ContextType>;
  getChannelPeers?: Resolver<ResolversTypes['ChannelPeer'][], ParentType, ContextType>;
...
export type TransactionDataResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['TransactionData'] = ResolversParentTypes['TransactionData']
> = {
  ...
  id_bytes?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  input_args?: Resolver<ResolversTypes['String'][], ParentType, ContextType>;
  ...
  endorsements?: Resolver<ResolversTypes['Endorsement'][], ParentType, ContextType>;
};

export type TransactionResponseResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['TransactionResponse'] = ResolversParentTypes['TransactionResponse']
> = {
...
export type WalletEntryResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['WalletEntry'] = ResolversParentTypes['WalletEntry']
> = {
...
export type X509AttributeResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['X509Attribute'] = ResolversParentTypes['X509Attribute']
> = {
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
