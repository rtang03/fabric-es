...
export type ResolversTypes = {
  ...
  DocContents: ResolverTypeWrapper<
    Omit<DocContents, 'content'> & { content?: Maybe<ResolversTypes['Docs']> }
  >;
...
export type ResolversParentTypes = {
  ...
  DocContents: Omit<DocContents, 'content'> & {
    content?: Maybe<ResolversParentTypes['Docs']>;
  };
...
> = {
  documentId?: Resolver<
    ...
    ContextType
  >;
  content?: Resolver<Maybe<ResolversTypes['Docs']>, ParentType, ContextType>;
  timestamp?: Resolver<
    Maybe<ResolversTypes['String']>,
    ParentType,
    ContextType
