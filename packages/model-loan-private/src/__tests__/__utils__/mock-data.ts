...
const db: Record<string, Commit> = {
  '20181114163145794:123456': {
    ...
    events: [
      ...
      {
        payload: { loanId: '123456', userId: 'josh@fake.it', startDate: 1542336644365, timestamp: 1542336654365 },
        type: 'LoanStartDateDefined'
      },
      {
        payload: { loanId: '123456', userId: 'josh@fake.it', tenor: 90, timestamp: 1542336654365 },
        type: 'LoanTenorDefined'
      },
      {
        payload: { loanId: '123456', userId: 'josh@fake.it', currency: 'CNY', timestamp: 1542336654365 },
        type: 'LoanCurrencyDefined'
      },
      {
        payload: { loanId: '123456', userId: 'josh@fake.it', requestedAmt: 900000.0, timestamp: 1542336654365 },
        type: 'LoanRequestedAmtDefined'
      },
      {
        payload: { loanId: '123456', userId: 'josh@fake.it', loanType: 'Post-shipment', timestamp: 1542336654365 },
  ...
  '20181114163147794:1542385173331': {
    ...
    events: [
      {
        type: 'DocContentsCreated',
        payload: { documentId: '1542385173331', userId: 'josh@fake.it', timestamp: 1542336654369 }
      },
      {
  ...
  '20181114163147794:1542385174331': {
    ...
    events: [
      {
        type: 'DocContentsCreated',
        payload: { documentId: '1542385174331', userId: 'josh@fake.it', timestamp: 1542336654369 }
      },
      {
