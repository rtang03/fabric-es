// import type { BaseMetaEntity, Commit, Paginated } from '@fabric-es/fabric-cqrs';
...
// import type { QueryHandlerResolvers } from './types';
//
...
//     ),
//     fullTextSearchEntity: catchErrors<Paginated<any>>(
//       async (
//         _,
//         { query, cursor = 0, pagesize = 10 },
//         { queryHandler }
