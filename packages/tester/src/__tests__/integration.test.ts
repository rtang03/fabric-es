...
// require('dotenv').config({ path: './.env.1.test' });
// const HOST_GATE1 = process.env.GATEWAY_HOST || 'localhost';
// const PORT_GATE1 = process.env.GATEWAY_PORT || 4001;
// const HOST_AUTH1 = process.env.AUTH_HOST || 'localhost';
// const PORT_AUTH1 = process.env.AUTH_PORT || 4100;

// require('dotenv').config({ path: './.env.2.test' });
// const HOST_GATE2 = process.env.GATEWAY_HOST || 'localhost';
// const PORT_GATE2 = process.env.GATEWAY_PORT || 4002;
// const HOST_AUTH2 = process.env.AUTH_HOST || 'localhost';
// const PORT_AUTH2 = process.env.AUTH_PORT || 4200;

// require('dotenv').config({ path: './.env.3.test' });
// const HOST_GATE3 = process.env.GATEWAY_HOST || 'localhost';
// const PORT_GATE3 = process.env.GATEWAY_PORT || 4003;
// const HOST_AUTH3 = process.env.AUTH_HOST || 'localhost';
// const PORT_AUTH3 = process.env.AUTH_PORT || 4300;
/*
const fs = require('fs')
...
const AUTH_SERVER1 = `http://${HOST_AUTH1}:${PORT_AUTH1}/graphql`;
const AUTH_SERVER2 = `http://${HOST_AUTH2}:${PORT_AUTH2}/graphql`;
const AUTH_SERVER3 = `http://${HOST_AUTH3}:${PORT_AUTH3}/graphql`;
const GATEWAY1 = `http://${HOST_GATE1}:${PORT_GATE1}/graphql`;
const GATEWAY2 = `http://${HOST_GATE2}:${PORT_GATE2}/graphql`;
const GATEWAY3 = `http://${HOST_GATE3}:${PORT_GATE3}/graphql`;
...
describe('Test', () => {
  it('Test ENV', () => {
    console.log('1', GATEWAY1, AUTH_SERVER1);
    console.log('2', GATEWAY2, AUTH_SERVER2);
    console.log('3', GATEWAY3, AUTH_SERVER3);
